"""Full-model quantized inference simulation with ARHQ/SVDQuant low-rank compensation.

Usage:
  # Perplexity evaluation on wikitext2
  CUDA_VISIBLE_DEVICES=2 conda run -n llmc --no-capture-output python -m arhq.evaluate_model \
